...
class Cookie_order:
    ...
    def __init__(self,cookie_order):
        ...
        self.customer_name = cookie_order["customer_name"]
    ...
    def create(cls, cookie_order):
        ...
        query = """
                INSERT into cookie_orders (customer_name, name, cookie_type, num_boxes)
                VALUES  (%(customer_name)s, %(name)s, %(cookie_type)s, %(num_boxes)s);"""
